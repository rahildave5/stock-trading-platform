                ...
                <div className="row">
                    ...
                    <div className="col-5 awards-copy" >
                        ...
                        <div className="z-functions">
                            ...
                            <div className="why-us">
                                <p>No gimmicks, spam, "gamification", or annoying push notifications. High quality apps that you use at your pace, the way you like. 
                                    <a href="/">Our philosophies.</a></p>
                            </div>
                        </div>
                        <div className="z-functions">
                    ...
                    <div className="col-7">
                        ...
                        <p className='text-center' style={{ margin: '16px 0 15px' }}>
                            <a className='fs-6' href="/">Explore our demo <i class="fa-solid fa-arrow-right" style={{fontSize: '14px'}}></i></a>
                            <a className='fs-6' href="/" style={{ marginLeft: '28px'}}>Try Kite demo <i class="fa-solid fa-arrow-right" style={{fontSize: '14px'}}></i></a>
                        </p>
                    </div>
                    <div className="press">
                        <a href='/media'>
