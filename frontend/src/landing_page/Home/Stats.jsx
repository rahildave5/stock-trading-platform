...
function Stats() {
  return (
    <h1>
      <section className="ecosystem" style={{ paddingBottom: "120px" }}>
          ...
          <div className="row">
              ...
              <div className="z-functions">
                ...
                <div className="why-us">
                  <p>
                    ...
                    transactions, but actively help you do better with your
                    money.
                  </p>
                </div>
              </div>
            ...
            <div className="col-7">
              ...
              <p className="text-center" style={{ margin: "16px 0 15px" }}>
                ...
                <a className="fs-6" href="/" style={{ marginLeft: "28px" }}>
                  Try Kite demo{" "}
                  <i
                    class="fa-solid fa-arrow-right"
                    style={{ fontSize: "14px" }}
